						...
						<div class="box-body" ng-controller="automateController">
							...
							<div class="col-md-6" >
								...
								<div class="form-group">
									...
									{!! Form::text('facebook', null, array('class' => 'form-control', 'ng-model'=>'qty')) !!}
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									{!! Form::textarea('company_information', null, array('class' => 'form-control', 'rows'=>3, 'required')) !!}
								</div>
								<div class="form-group">
									{!! Form::label('logo_path', 'Company Logo', ['class'=>'text-right']) !!}
									{!! Form::file('logo_path', null, array('class' => 'form-control',  'required')) !!}
									@php
										$media = $eventprovider->getMedia('event_provider_image')->last();
								...
								<div class="form-group">
									...
									{!! Form::text('logo_name', $bmedia_name, array('class' => 'form-control')) !!}
								</div>
								<div class="form-group">
									{!! Form::label('logo_alt_tag_name', 'Image Alt Tag',['class'=>'text-right']) !!}
									{!! Form::text('logo_alt_tag_name', null, array('class' => 'form-control')) !!}
								</div>
								<div class="">
