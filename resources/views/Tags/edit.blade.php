					...
					<div class="box">
						...
						<div class="box-body">
							...
							<div class="col-md-6" >
								...
								<div class="form-group">
									{!! Form::label('description', 'Short Description', ['class'=>'text-right']) !!}
									{!! Form::textarea('description', null, array('class' => 'form-control', "rows"=>2)) !!}
								</div>
								<div class="form-group">
										{!! Form::label('tag_image', 'Tag Image', ['class'=>'text-right']) !!}
										{!! Form::file('tag_image', null, array('class' => 'form-control')) !!}
										@php
											$media = $tag->getMedia('tag_image')->first();
