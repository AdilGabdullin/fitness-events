            ...
            <div class="box-body">
				...
				<div class="col-sm-12" >
					...
					<div class="form-group">
						...
						{!! Form::select('blog_category_id', $blog_categories , null, array('class' => 'form-control', 'required')) !!}
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						{!! Form::textarea('main_content', null, array('class' => 'form-control', 'id'=>'main_content', "rows"=>5)) !!}
					</div>
